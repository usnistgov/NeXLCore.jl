...
# ╔═╡ 92e150f0-f5f3-11eb-33a3-c39993e395ef
using NeXLCore

# ╔═╡ 489dd119-d9e6-46cd-ac3d-5e1d6b3c0bb5
using Gadfly, PlutoUI  # Load plotting and UI libraries

# ╔═╡ b2e92442-ada2-457c-bbb5-b824fcfbfdcf
md"
## Mass Absorption Coefficients

This notebook generates an interactive plot of X-ray mass absorption coefficients.
"

# ╔═╡ 10444fa1-c990-41e3-b742-52e709de6f6b
md"
Select an element using the slider.
"

# ╔═╡ f0c903b0-1485-49fa-9e08-27189b405d63
@bind zz Slider(1:92)
...
[[BoteSalvatICX]]
deps = ["Requires"]
git-tree-sha1 = "c8da8dc6ca8566e210dfb1ed7f07e70ccd61d871"
uuid = "fe54227b-96c7-489b-9963-dd1ce2905f30"
version = "2.0.0"
...
[[FFAST]]
deps = ["CSV", "DataFrames", "Requires"]
git-tree-sha1 = "24869b1eff1eaa7f7dee1a52e4b9fece34b44bb4"
uuid = "10506e09-08cd-5f0b-aee5-631de1bcc925"
version = "2.0.4"
...
[[NeXLCore]]
deps = ["BoteSalvatICX", "CSV", "Colors", "CoordinateTransformations", "DataFrames", "Dierckx", "FFAST", "FileIO", "GeometryBasics", "LaTeXStrings", "LinearAlgebra", "NeXLUncertainties", "PeriodicTable", "PhysicalConstants", "Pkg", "Printf", "QuadGK", "Random", "Reexport", "Requires", "StaticArrays", "Statistics", "Unitful"]
git-tree-sha1 = "2d5223af8025e56e1ef15eb86b95e040fc2c3ff9"
uuid = "93a0284f-3680-435e-8d39-dd6e52a1dbc8"
version = "0.2.6"

[[NeXLUncertainties]]
deps = ["DataFrames", "Distributions", "Formatting", "LaTeXStrings", "LinearAlgebra", "Printf", "Random", "Statistics"]
git-tree-sha1 = "f7ffd91efbb6426734819732b187fe4894ebd6d3"
...
git-tree-sha1 = "067ef5738ef3157f29749c32b64f0ff9b3d07ab2"
