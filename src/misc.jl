...
struct Poehn1985 <: JumpRatio end

"""
    jumpratio(::Type{Poehn1985}, ashell::AtomicSubShell)

An implement of jump ratios attributed to
  * Poehn, Wernisch, Hanke (1985) X-ray Spectrom 14(3):120, 1985
"""
function jumpratio(::Type{Poehn1985}, ashell::AtomicSubShell)
    zz = ashell.z
...
struct Castellano2004 <: BremmstrahlungModel end
"""
...
"""
function bremsstrahlung(::Type{Castellano2004}, elm::Element, e0::Real, e::Real)
...
struct Burhop1965 <: FluorescenceYield end

"""
    fluorescenceyield(::Type{Burhop1965}, z::Int)

An approximate expression for the K-shell fluorescence yield due to
E.H.S Burhop, J. Phys. Radium, 16, 625 (1965)
"""
function fluorescenceyield(::Type{Burhop1965}, z::Int)
