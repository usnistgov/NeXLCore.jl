...
@testset "Backscatter - Material" begin
    ...
    @test isapprox(η(LoveScott1978η, n"C", 10.0e3),η(LoveScott1978η, mat"0.9999*C+0.0001*H", 10.0e3),atol=1.0e-5)
    @test isapprox(η(LoveScott1978η, n"U", 30.0e3),η(LoveScott1978η, mat"0.99999*U+0.00001*H", 30.0e3),atol=1.0e-5)
    @test isapprox(η(LoveScott1978η, n"C", 10.0e3),η(LoveScott1978η, mat"0.9999*C+0.0001*H", 10.0e3),atol=1.0e-5)

    @test isapprox(NeXLCore.electronfraction(n"Au",mat"0.756*Au+0.244*Cu"), 0.731, atol=0.001)
