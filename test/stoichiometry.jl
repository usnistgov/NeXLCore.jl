...
@testset "Stoichiometry" begin
  ...
  @test isapprox(obystoichiometry(n"Mg"=>0.116567,n"Al"=>0.0490615,n"Si"=>0.211982, n"Ca"=>0.10899,n"Fe"=>0.0774196), 0.4276, atol=0.0001)
  ...
  amix = 0.4*atomicfraction("SiO2",n"Si"=>1,n"O"=>2)+0.6*atomicfraction("Al2O3",n"Al"=>2,n"O"=>3)
